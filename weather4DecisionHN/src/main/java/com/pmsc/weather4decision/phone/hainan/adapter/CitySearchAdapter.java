...
public class CitySearchAdapter extends BaseAdapter {
	...
	public CitySearchAdapter(List<JsonMap> datas) {
		this.datas = datas;
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		String xianqu = getItem(position).getString("xianqu");
		String district = getItem(position).getString("district");
		String province = getItem(position).getString("province");
		titleTv.setText(xianqu + " - " + district + " - " + province);
		return titleTv;
	}
