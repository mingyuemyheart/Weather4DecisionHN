...
public class TyphoonDto {
	...
	public String time;
	public boolean isFactPoint = true;//判断为实况点或预报点
...
//		}
		...
		buffer.append("中心位置："+lat+"N/"+lng+"E").append("\n");
		...
		if(!TextUtils.isEmpty(max_wind_speed)){
			...
			buffer.append(" "+WeatherUtil.getHourWindForce(Float.parseFloat(max_wind_speed))+"\n");
		}
		if (!TextUtils.isEmpty(type)) {
